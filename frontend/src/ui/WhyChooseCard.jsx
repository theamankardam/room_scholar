...
// Importing sleek, clean icons matching your UI layout
...
const WhyChooseCard = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Stay close to universities, transport, and city attractions."
    },
    {
      id: 3,
      icon: <MdOutlineWeekend className="w-8 h-8 text-slate-700" />,
      title: "Fully Furnished",
      description: "Move in hassle-free with stylish furniture and modern amenities."
    },
    {
      id: 4,
    ...
    },
    {
      ...
      title: "24/7 Support",
      description: "Our team is always here to support you throughout your stay."
    }
  ];
