...
export default function PromoBanner() {
  return (
    <section className="px-4 pb-16 max-w-7xl mx-auto w-full">
      <div className="bg-[#0A192F] text-white rounded-3xl overflow-hidden shadow-xl grid grid-cols-1 lg:grid-cols-12 min-h-95">
        <div className="lg:col-span-5 p-6 md:p-10 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-800/80">
          <div>
            ...
            <p className="text-slate-300 text-sm md:text-base italic leading-relaxed max-w-md">
              "Room Scholars made finding my accommodation in London so easy.
              The place is amazing and the support is excellent!"
            </p>
          </div>
        ...
        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-12 relative overflow-hidden bg-linear-to-br from-[#0A192F] to-[#0d203d]">
          ...
          <div className="hidden md:block md:col-span-5 relative h-full min-h-75 lg:min-h-full">
            ...
            <img
              ...
              alt="Student"
              className="hidden lg:flex absolute bottom-0 right-0 h-full xl:h-[105%] w-full object-cover object-top select-none z-10"
            />
          </div>
        </div>
      </div>
